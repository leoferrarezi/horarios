<div class="modal fade" id="modal-import-turmas" tabindex="-1" aria-labelledby="ModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Importar Turmas:<br>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="alert alert-primary text-dark" role="alert">
                        ...
                        Ensino -> Turmas e Diários -> Turmas<br>
                        Aplicar os devidos filtros (Ano Letivo, Campus, etc)<br>
            ...
            <form id="importarTurmas" class="forms-sample" method="post" action='<?php echo base_url('sys/turma/importar'); ?>' enctype="multipart/form-data">
