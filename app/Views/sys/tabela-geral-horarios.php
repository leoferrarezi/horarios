...
<script>
    ...
    $(document).ready(function() {
        ...
        function abrirModalAmbiente(aulaId) {
            ...
            // Armazena o ID da aula para uso posterior
            $('#modalSelecionarAmbiente').data('aula-id', aulaId);
